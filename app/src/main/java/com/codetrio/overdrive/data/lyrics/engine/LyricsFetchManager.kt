...
import com.codetrio.overdrive.data.lyrics.LrcLibApi
...
import com.codetrio.overdrive.data.lyrics.providers.KugouProvider
import com.codetrio.overdrive.data.lyrics.providers.BetterLyricsProvider
import com.codetrio.overdrive.data.lyrics.providers.SimpMusicProvider
...
class LyricsFetchManager private constructor(context: Context) {
    ...
    private fun createProviders(client: OkHttpClient): List<LyricsProvider> {
        ...
        // ═══════════════════════════════════════════
        providers.add(com.codetrio.overdrive.data.lyrics.providers.YouTubeMusicLyricsProvider())
        ...
        val syncLrcApi = Retrofit.Builder()
            ...
            .build()
            .create(com.codetrio.overdrive.data.lyrics.SyncLrcApi::class.java)
        ...
        val kugouLegacyApi = Retrofit.Builder()
            ...
            .addConverterFactory(gsonConverter)
            .build()
            .create(com.codetrio.overdrive.data.lyrics.KugouLegacyApi::class.java)
        ...
        providers.add(com.codetrio.overdrive.data.lyrics.providers.YouLyPlusProvider())

        // YouTube Subtitle (timed transcript captions)
        providers.add(com.codetrio.overdrive.data.lyrics.providers.YouTubeSubtitleProvider())

        // Paxsenix providers — no Retrofit needed; PaxsenixLyrics singleton handles HTTP with OkHttp
        providers.add(com.codetrio.overdrive.data.lyrics.providers.paxsenix.PaxsenixAppleMusicProvider(appContext))
        providers.add(com.codetrio.overdrive.data.lyrics.providers.paxsenix.PaxsenixSpotifyProvider(appContext))
        providers.add(com.codetrio.overdrive.data.lyrics.providers.paxsenix.PaxsenixMusixmatchProvider(appContext))
        providers.add(com.codetrio.overdrive.data.lyrics.providers.paxsenix.PaxsenixNeteaseProvider(appContext))
        providers.add(com.codetrio.overdrive.data.lyrics.providers.paxsenix.PaxsenixYouTubeProvider(appContext))
        providers.add(com.codetrio.overdrive.data.lyrics.providers.SyncLrcProvider(syncLrcApi))
