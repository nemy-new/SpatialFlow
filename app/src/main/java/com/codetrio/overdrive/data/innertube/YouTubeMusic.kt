...
object YouTubeMusic {
    ...
    fun prefetchStream(videoId: String?) {
        if (videoId.isNullOrEmpty()) return
        com.codetrio.overdrive.data.innertube.NewPipeStreamExtractor.prefetchBatch(
            listOf(videoId), 
            com.codetrio.overdrive.data.innertube.NewPipeStreamExtractor.PrefetchPriority.LOW
        )
    }
     ...
     */
    fun preCacheNextSong(song: com.codetrio.overdrive.model.SongItem) {
