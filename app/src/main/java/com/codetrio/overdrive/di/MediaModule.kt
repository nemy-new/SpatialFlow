...
object MediaModule {
    ...
    @Provides
    @Singleton
    fun provideStreamRepository(): com.codetrio.overdrive.domain.repository.StreamRepository {
        return com.codetrio.overdrive.data.repository.InnerTubeStreamRepository()
    }
}
