...
fun WelcomeGreetingBanner(userName: String?) {
    ...
    val iconResId = remember(hour) {
        when (hour) {
            in 0..11 -> com.codetrio.overdrive.R.drawable.ic_morning
            in 12..16 -> com.codetrio.overdrive.R.drawable.ic_afternoon
            else -> com.codetrio.overdrive.R.drawable.ic_evening
        }
    }
        ...
        Column(
            ...
            val menuItems = listOf(
                Triple("Start mix", Icons.Default.Radio) {
                    ...
                    com.codetrio.overdrive.ui.SnackbarController.showMessage("Starting mix based on ${song.title}")
                    onDismissRequest()
                },
                ...
                Triple("Go to album", Icons.Default.Album) {
                    ...
                    if (!id.isNullOrBlank()) {
                        ...
                        com.codetrio.overdrive.ui.SnackbarController.showMessage("Album information unavailable")
                    }
                },
                ...
                Triple(
                    ...
                    com.codetrio.overdrive.ui.SnackbarController.showMessage(msg)
                    onDismissRequest()
                },
                Triple("Not interested", Icons.Default.Block) {
                    exploreViewModel.setNotInterested(song)
                    com.codetrio.overdrive.ui.SnackbarController.showMessage("We will suggest fewer songs like this")
                    onDismissRequest()
                }
            )
...
fun CommunityExpressiveCard(
    ...
    val colors = remember(bitmap) { 
        if (bitmap != null) {
            com.codetrio.overdrive.ui.player.PlayerColorExtractor.extractFromBitmap(id, bitmap) 
        } else {
            com.codetrio.overdrive.ui.player.ExtractedPaletteColors.Default
        }
    }
