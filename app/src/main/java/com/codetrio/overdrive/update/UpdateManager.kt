package com.codetrio.overdrive.update
...
class UpdateManager(private val context: Context) {
    ...
    fun showUpdateNotification(tagName: String, changelog: String, apkUrl: String) {
        ...
        val intent = Intent(context, com.codetrio.overdrive.MainActivity::class.java).apply {
        ...
        val color = androidx.core.content.ContextCompat.getColor(context, com.codetrio.overdrive.R.color.md_theme_primary)

        val builder = NotificationCompat.Builder(context, "spatialflow_updates")
            .setSmallIcon(com.codetrio.overdrive.R.drawable.ic_applogo)
            ...
            .setShowWhen(true)
            .addAction(
                com.codetrio.overdrive.R.drawable.ic_download,
                "Update Now",
                pendingIntent
            )
