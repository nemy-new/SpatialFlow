...
fun SongItem.toPlaylistSongEntity(playlistId: Long, position: Int = 0): com.codetrio.overdrive.data.db.PlaylistSongEntity {
    return com.codetrio.overdrive.data.db.PlaylistSongEntity(
...
fun com.codetrio.overdrive.data.db.PlaylistSongEntity.toSongItem(): SongItem {
